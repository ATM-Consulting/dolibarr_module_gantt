...
/**
 * 	\defgroup   gantt     Module Gantt
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/gantt/core/modules directory.
 *  \file       htdocs/gantt/core/modules/modGantt.class.php
 *  \ingroup    gantt
 *  \brief      Description and activation file for module Gantt
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Gantt
 */
class modGantt extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		// for specific css file (eg: /gantt/css/gantt.css.php)
		...
		//							'css' => array('/gantt/css/gantt.css.php'),	// Set this to relative path of css file if module has its own css file
		//							'js' => array('/gantt/js/gantt.js'),          // Set this to relative path of js file if module must load a js on all pages
		...
		{
			$conf->gantt=new stdClass();
			$conf->gantt->enabled=0;
		}
		$this->dictionaries=array();
		/* Example:
		 if (! isset($conf->gantt->enabled)) $conf->gantt->enabled=0;	// This is to avoid warnings
		 $this->dictionaries=array(
		 'langs'=>'mylangfile@gantt',
	...
	/**
	 * Extend `projet` and `projet_task` with ExtraFields
	 */
