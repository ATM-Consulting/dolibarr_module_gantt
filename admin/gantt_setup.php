...
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$langs->trans("GANTT_ALLOW_TO_IMPACT_EVENT_ON_TASK").'</td>';
print '<td align="center" width="20">&nbsp;</td>';
print '<td align="right" width="300">';
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
print '<input type="hidden" name="action" value="set_GANTT_ALLOW_TO_IMPACT_EVENT_ON_TASK">';
echo ajax_constantonoff('GANTT_ALLOW_TO_IMPACT_EVENT_ON_TASK');
print '</form>';
print '</td></tr>';
